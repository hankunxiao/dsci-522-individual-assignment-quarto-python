...
![Horse populations for all provinces in Canada from 1906 - 1972](../results/horse_pops_plot.png){#fig-horse_pops_plot width=50%}
...
We present the standard deviations in (@tbl-std_table).
...
Additionally, note that in @tbl-std_table we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_pops_plot.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-horse_pops_plot_largest_sd width=50%}
